...
from fieldcompare import FieldDataComparator, FieldComparisonStatus, protocols
...
def _test_from_mesh(mesh_fields: mesh_protocols.MeshFields, basefilename: str = "", step_multiplier: float = 1.0) -> bool:
    ...
    return not any(r.status in [FieldComparisonStatus.failed, FieldComparisonStatus.error] for r in result)
