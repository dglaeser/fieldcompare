...
from fieldcompare import FieldDataComparator, FieldComparisonEvent, protocols
...
def _test_from_mesh(mesh_fields: mesh_protocols.MeshFields, basefilename: str = "", step_multiplier: float = 1.0) -> bool:
    ...
    return not any(r.failed and r.event == FieldComparisonEvent.none for r in result)
